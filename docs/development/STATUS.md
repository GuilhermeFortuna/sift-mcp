...
| [UI-003](specs/UI-003-observability-ui-spec.md) / [Plan](plans/UI-003-observability-ui-plan.md)                 | 01    | `DONE`  | UI-002                       | Shared application shell, Overview, and Activity with accessible live diagnostic views                           |
| [UI-004](specs/UI-004-repository-operations-ui-spec.md) / [Plan](plans/UI-004-repository-operations-ui-plan.md) | 01    | `DONE`  | UI-003                       | Registration, honest freshness inspection, explicit start/update/rebuild, and durable progress views             |
| [UI-005](specs/UI-005-search-lab-ui-spec.md) / [Plan](plans/UI-005-search-lab-ui-plan.md)                       | 01    | `READY` | UI-004                       | Query/snippet search, symbol inspection, complete-console validation, and local distribution                     |
