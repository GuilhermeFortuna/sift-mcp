...
| [UI-002](specs/UI-002-console-service-spec.md) / [Plan](plans/UI-002-console-service-plan.md)                   | 01    | `READY`   | UI-001                       | Local Rust HTTP service, repository registry, bounded history, action API, live updates, and frontend foundation |
