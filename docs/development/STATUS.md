...
| ID                                                                                                              | Batch | Status    | Depends on         | Deliverable                                                                                                      |
| --------------------------------------------------------------------------------------------------------------- | ----- | --------- | ------------------ | ---------------------------------------------------------------------------------------------------------------- |
| [UI-001](specs/UI-001-daemon-observability-spec.md) / [Plan](plans/UI-001-daemon-observability-plan.md)         | 01    | `READY`   | SIFT-010, SIFT-011 | Passive daemon observation, safe request events, indexing snapshots, and truthful resource measurements          |
